...
- [ ] `[cli|mcp|desktop]` SKIP: no dangerous actions — all tools are read-only image analysis
...
- [ ] `[cli]` SKIP: STDIO server, no interactive CLI flags beyond entry point
- [x] `[cli|mcp|desktop]` Logging levels defined: silent / normal / verbose / debug — secrets redacted at all levels (2026-04-09)
- [x] `[mcp]` All tools documented with description + parameters (2026-04-09)
- [ ] `[complex]` SKIP: no background daemons or operational modes
...
- [ ] `[all]` SKIP: private repo, no CI yet — dependency scanning deferred
- [ ] `[all]` SKIP: private repo — automated dependency updates deferred
